...
void Penta10::calc1stDerivField_TPB(double *dataIn, double *dataOut, double *Nm2, double *Nm1, double *Np1, double *Np2){
...
void Penta10::calc2ndDerivField(double *dataIn, double *dataOut){
...
void Penta10::calc2ndDeriv(double *phi, double *dphi){
...
void Penta10::multRHS2ndDerivPeriodic(double dh, double *phi, int N, double *RHSvec){
...
void Penta10::multRHS2ndDerivDirichlet(double dh, double *phi, int N, double *RHSvec){
...
void Penta10::Compact2ndPeriodic(double *phi, double *dphidy){
...
void Penta10::Compact2ndDirichlet(double *phi, double *dphidy){
